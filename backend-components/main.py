...
def main():
    ...
    ## HomeAssistant
    token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJiZjcxYjNjZDdjNWE0M2I5OGE5MzNjZTNkNDcxZGEzMiIsImlhdCI6MTc1MDMzMTcxMSwiZXhwIjoyMDY1NjkxNzExfQ.7PNXjkckqmYeYgB9YO8L1LSjAtx0W7OMqJlUBaPSG7A"
